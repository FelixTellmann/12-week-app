...
export const Dashboard_beta: FC<IndexProps> = ({}) => {
    const [data] = useState([
      {
        week: 1,
        status: "complete",
        ...
        <Main minH="100vh" maxW={800} m="auto" px={5} py={8}>
          ...
          <Div d="flex" justify="space-between">
            ...
            {data.map(({ week, goal1, goal2, status }) => (
              ...
              <Div key={week} p={4} opacity={status === 'active' ? 1 : status === 'complete' ? 0.8 : 0.4} _hfa={{opacity: 1}} transition="0.1s ease-in" cursor="pointer">
